...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 31-05-2021 a las 01:38:31
...
CREATE TABLE `actividad` (
  ...
  `estado` enum('Pendiente','Proceso','Terminada') COLLATE utf8_spanish2_ci NOT NULL,
  `finca` int(10) UNSIGNED NOT NULL
...
INSERT INTO `actividad` (`id_actividad`, `nombre`, `descripcion`, `estado`, `finca`) VALUES
(2, 'guadañar', 'sera guadañado el lote numero 3', 'Pendiente', 7);

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `act_inventario`
--

CREATE TABLE `act_inventario` (
  `id_herramienta` int(10) UNSIGNED NOT NULL,
  `actividad_l` int(10) UNSIGNED NOT NULL,
  `producto` int(10) UNSIGNED NOT NULL,
  `cantidad` smallint(4) UNSIGNED DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_spanish2_ci;

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `asignar_empleado`
--

CREATE TABLE `asignar_empleado` (
  `id_asignar` int(10) UNSIGNED NOT NULL,
  `empleado` int(10) UNSIGNED NOT NULL,
  `actividad_l` int(10) UNSIGNED NOT NULL,
  `fecha_inicio` date NOT NULL,
  `fecha_fin` date NOT NULL,
  `calificacion` enum('Muy_bueno','Bueno','Regular','Malo','Muy_malo') COLLATE utf8_spanish2_ci DEFAULT NULL,
...
CREATE TABLE `categoria` (
  ...
  `tipo` enum('Animal','Cultivo') COLLATE utf8_spanish2_ci NOT NULL,
  `produce` varchar(120) COLLATE utf8_spanish2_ci DEFAULT NULL,
  `finca` int(10) UNSIGNED NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_spanish2_ci;
...
INSERT INTO `categoria` (`id_cat`, `categoria`, `tipo`, `produce`, `finca`) VALUES
(2, 'manzano', 'Cultivo', 'manzanas', 2),
(3, 'peras', 'Cultivo', 'peras azul', 2),
(5, 'vacas', 'Animal', 'leche', 5),
(6, 'pollos', 'Animal', 'carne', 5),
(7, 'manzano', 'Cultivo', 'manzanas verde', 7),
(8, 'vacas', 'Animal', 'leche', 7);

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `cat_lote`
--

CREATE TABLE `cat_lote` (
  `id_lot_cat` int(10) UNSIGNED NOT NULL,
  `lote` int(10) UNSIGNED NOT NULL,
  `categoria` int(10) UNSIGNED NOT NULL,
  `cantidad` smallint(2) UNSIGNED DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_spanish2_ci;
...
CREATE TABLE `empleado` (
  ...
  `correo` varchar(75) COLLATE utf8_spanish2_ci DEFAULT 'nn@nn.com',
  `telefono` char(11) COLLATE utf8_spanish2_ci NOT NULL,
  `tipo_contrato` enum('Fijo','Temporal') COLLATE utf8_spanish2_ci NOT NULL,
...
INSERT INTO `empleado` (`id_empleado`, `cedula`, `nombres`, `apellidos`, `correo`, `telefono`, `tipo_contrato`, `salario`, `finca`, `estado`) VALUES
(1, '123', 'pedro', 'diaz', 'pedrodiaz@gmail.com', '3245874', 'Temporal', 780000, 1, 'activo'),
(2, '12345', 'Coffee', 'light', 'coffe@gmail.com', '15964531', 'Temporal', 1000000, 7, 'activo');
...
CREATE TABLE `finca` (
  ...
  `usuario` char(11) COLLATE utf8_spanish2_ci NOT NULL,
  `extencion` float(9,2) NOT NULL,
  `departamento` smallint(2) UNSIGNED DEFAULT 0,
  `municipio` mediumint(6) UNSIGNED DEFAULT 0
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_spanish2_ci;
...
INSERT INTO `finca` (`id_finca`, `nombre`, `usuario`, `extencion`, `departamento`, `municipio`) VALUES
(1, 'la florencia', '12340', 1750.00, 5, 92),
(2, 'dante', '100473', 3000.00, 8, 769),
(3, 'luancito', '1054', 4500.00, 8, 740),
(4, 'pepe1', '1597', 1250.00, 13, 418),
(5, 'pepe2', '1597', 3000.00, 88, 685),
(6, 'La carola', '42136015', 200.00, 66, 657),
(7, 'La susana', '42136015', 1000.00, 66, 543);
...
CREATE TABLE `inventario` (
  ...
  `nombre` varchar(40) COLLATE utf8_spanish2_ci NOT NULL,
  `descripcion` varchar(200) COLLATE utf8_spanish2_ci DEFAULT NULL,
  `medida` smallint(6) UNSIGNED NOT NULL,
  `tipo` enum('Litros','Mililitros','Kilos','Gramos','Metros','Centimetros','Unidades') COLLATE utf8_spanish2_ci NOT NULL,
  `precio_und` int(7) UNSIGNED NOT NULL,
...
INSERT INTO `inventario` (`id_producto`, `nombre`, `descripcion`, `medida`, `tipo`, `precio_und`, `stock`, `finca`) VALUES
(2, 'pala', 'palo de madera con punta metalica que sirve para enterrar', 1, 'Kilos', 25000, 3, 2),
(3, 'veneno', 'mata bichos', 250, 'Litros', 6500, 3, 7),
(4, 'cafe ', 'cafe para los empleados', 750, 'Gramos', 3500, 3, 3);
...
INSERT INTO `lote` (`id_lote`, `nombre`, `finca`, `extencion`) VALUES
(5, 'noreste', 2, 300.00),
(6, 'luansur', 3, 250.00),
(7, 'lote1p', 5, 250.00),
(9, 'lote3', 5, 450.00),
...
--
-- Estructura de tabla para la tabla `lote_actividad`
--

CREATE TABLE `lote_actividad` (
  `id_lot_act` int(10) UNSIGNED NOT NULL,
  `lote` int(10) UNSIGNED NOT NULL,
...
CREATE TABLE `municipios` (
  `id_municipio` mediumint(6) UNSIGNED NOT NULL,
  `municipio` varchar(255) COLLATE utf8_spanish2_ci NOT NULL DEFAULT '',
  `estado` smallint(3) UNSIGNED NOT NULL,
  `departamento_id` smallint(2) UNSIGNED NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_spanish2_ci;
...
CREATE TABLE `usuario` (
  ...
  `nombres` varchar(40) COLLATE utf8_spanish2_ci NOT NULL,
  `apellidos` varchar(40) COLLATE utf8_spanish2_ci NOT NULL,
  `correo` varchar(75) COLLATE utf8_spanish2_ci NOT NULL DEFAULT 'nn@nn.com',
...
INSERT INTO `usuario` (`id_usuario`, `nombres`, `apellidos`, `correo`, `contrasena`, `token`) VALUES
('100473', 'Juan Manuel', 'Castaño Leon', 'juma206jm@gmail.com', '7f1de29e6da19d22b51c68001e7e0e54', NULL),
('1054', 'luan', 'castañeda', 'luan@gmail.com', 'c26820b8a4c1b3c2aa868d6d57e14a79', NULL),
('123', 'maia', 'reficco', 'maia@hotmail.com', 'b9169690ddeaf27e0296dafa6b5e485e', NULL),
('12340', 'Coffee', 'castañeda', 'coffee@hotmail.com', '5583413443164b56500def9a533c7c70', NULL),
('1597', 'pepe', 'Perez', 'pepito@sena.com.co', '81dc9bdb52d04dc20036dbd8313ed055', NULL),
('42136015', 'Carolina', 'Leon', 'carito-leon@hotmail.com', '6f1a7662f70c9bb4d1b2a79baddab208', NULL),
('456', 'kally', 'ponce', 'kallyponce@gmail.com', '1d430d0a0757ca4b16a57dbc5c436353', NULL);
...
--
-- Indices de la tabla `act_inventario`
--
ALTER TABLE `act_inventario`
  ADD PRIMARY KEY (`id_herramienta`),
  ADD KEY `actividad_l` (`actividad_l`),
  ADD KEY `producto` (`producto`);

--
-- Indices de la tabla `asignar_empleado`
--
ALTER TABLE `asignar_empleado`
...
--
-- Indices de la tabla `cat_lote`
--
ALTER TABLE `cat_lote`
  ADD PRIMARY KEY (`id_lot_cat`),
  ADD KEY `lote` (`lote`),
...
--
-- Indices de la tabla `lote_actividad`
--
ALTER TABLE `lote_actividad`
  ADD PRIMARY KEY (`id_lot_act`),
  ADD KEY `lote` (`lote`),
...
--
-- AUTO_INCREMENT de la tabla `act_inventario`
--
ALTER TABLE `act_inventario`
  MODIFY `id_herramienta` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `asignar_empleado`
--
ALTER TABLE `asignar_empleado`
  MODIFY `id_asignar` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT de la tabla `cat_lote`
--
ALTER TABLE `cat_lote`
  MODIFY `id_lot_cat` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `finca`
  MODIFY `id_finca` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
...
--
ALTER TABLE `lote`
  MODIFY `id_lote` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;

--
-- AUTO_INCREMENT de la tabla `lote_actividad`
--
ALTER TABLE `lote_actividad`
  MODIFY `id_lot_act` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `actividad`
  ADD CONSTRAINT `actividad_ibfk_1` FOREIGN KEY (`finca`) REFERENCES `finca` (`id_finca`);

--
-- Filtros para la tabla `act_inventario`
--
ALTER TABLE `act_inventario`
  ADD CONSTRAINT `act_inventario_ibfk_1` FOREIGN KEY (`actividad_l`) REFERENCES `lote_actividad` (`id_lot_act`),
  ADD CONSTRAINT `act_inventario_ibfk_2` FOREIGN KEY (`producto`) REFERENCES `inventario` (`id_producto`);

--
-- Filtros para la tabla `asignar_empleado`
--
ALTER TABLE `asignar_empleado`
  ADD CONSTRAINT `asignar_empleado_ibfk_1` FOREIGN KEY (`empleado`) REFERENCES `empleado` (`id_empleado`),
  ADD CONSTRAINT `asignar_empleado_ibfk_2` FOREIGN KEY (`actividad_l`) REFERENCES `lote_actividad` (`id_lot_act`);

--
-- Filtros para la tabla `categoria`
--
ALTER TABLE `categoria`
  ADD CONSTRAINT `categoria_ibfk_1` FOREIGN KEY (`finca`) REFERENCES `finca` (`id_finca`);

--
-- Filtros para la tabla `cat_lote`
--
ALTER TABLE `cat_lote`
  ADD CONSTRAINT `cat_lote_ibfk_1` FOREIGN KEY (`lote`) REFERENCES `lote` (`id_lote`),
  ADD CONSTRAINT `cat_lote_ibfk_2` FOREIGN KEY (`categoria`) REFERENCES `categoria` (`id_cat`);

--
-- Filtros para la tabla `empleado`
--
ALTER TABLE `empleado`
  ADD CONSTRAINT `empleado_ibfk_1` FOREIGN KEY (`finca`) REFERENCES `finca` (`id_finca`);

--
-- Filtros para la tabla `finca`
--
ALTER TABLE `finca`
  ADD CONSTRAINT `finca_ibfk_1` FOREIGN KEY (`departamento`) REFERENCES `departamentos` (`id_departamento`),
  ADD CONSTRAINT `finca_ibfk_2` FOREIGN KEY (`municipio`) REFERENCES `municipios` (`id_municipio`),
  ADD CONSTRAINT `finca_ibfk_3` FOREIGN KEY (`usuario`) REFERENCES `usuario` (`id_usuario`);

--
-- Filtros para la tabla `inventario`
--
ALTER TABLE `inventario`
  ADD CONSTRAINT `inventario_ibfk_1` FOREIGN KEY (`finca`) REFERENCES `finca` (`id_finca`);

--
-- Filtros para la tabla `lote`
--
ALTER TABLE `lote`
  ADD CONSTRAINT `lote_ibfk_1` FOREIGN KEY (`finca`) REFERENCES `finca` (`id_finca`);

--
-- Filtros para la tabla `lote_actividad`
--
ALTER TABLE `lote_actividad`
  ADD CONSTRAINT `lote_actividad_ibfk_1` FOREIGN KEY (`lote`) REFERENCES `lote` (`id_lote`),
  ADD CONSTRAINT `lote_actividad_ibfk_2` FOREIGN KEY (`actividad`) REFERENCES `actividad` (`id_actividad`);
